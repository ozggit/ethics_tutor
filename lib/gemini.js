...
const OUTPUT_PROMPT =
  "ענה/י בעברית טבעית, מפורטת ומעודדת (5-10 משפטים), בפסקאות קצרות. " +
  "התחל/י במשפט חם כמו 'שאלה מעולה'. " +
  "השתמש/י בעיצוב Markdown עדין כשזה עוזר: כותרות מודגשות ונקודות. " +
  "פורמט מומלץ: **תמצית קצרה:** ... ואז **פירוט:** ... ואז **דוגמה מהחומר:** ... ואז **בדיקת הבנה:** שאלה קצרה. " +
